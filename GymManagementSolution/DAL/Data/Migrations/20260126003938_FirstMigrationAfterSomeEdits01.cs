...
{
    /// <inheritdoc />
    public partial class FirstMigrationAfterSomeEdits01 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserPhoneCheck", "Phone LIKE '010[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserPhoneCheck1", "Phone LIKE '010[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthRecord_Members_Id",
                        column: x => x.Id,
